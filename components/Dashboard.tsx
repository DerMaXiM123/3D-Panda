      ...
      <section className="flex-1 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-6 min-h-0 w-full">
         ...
         >
            ...
            <div className="relative z-10">
               ...
               <p className="text-blue-100 font-bold uppercase text-xs lg:text-base tracking-widest italic opacity-80 max-w-2xl leading-relaxed">Industrielle Präzision für Klemmbausteine. V6.2 Engine aktiv. Parametrische CAD-Lösung für FDM/SLA.</p>
            </div>
         ...
         <NodeCard icon={<QrCode />} label="Labels" desc="Asset Studio" onClick={() => onViewChange(AppView.QR_STUDIO)} color="cyan" />
